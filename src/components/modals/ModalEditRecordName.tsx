        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              autoFocus
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium text-gray-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:bg-white transition-all"
            />
          </div>
          ...
          <div className="flex items-center justify-end space-x-3 pt-2">
            ...
            <button
              type="submit"
              disabled={!name.trim()}
              className="inline-flex items-center px-5 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-sm font-semibold text-white shadow-xs hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
